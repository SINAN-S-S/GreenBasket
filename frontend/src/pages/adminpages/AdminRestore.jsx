...
const AdminRestore = () => {
  // State for storing deleted products and loading status
  const [products, setProducts] = useState([]);
  const [loading, setLoading] = useState(true);
  const { user } = useContext(AuthContext);

  // Fetch soft-deleted products from the backend trash
  ...
  // Load deleted products when the component mounts
  useEffect(() => {
