...
const AdminProducts = () => {
  // State for storing products, loading status, and selected category filter
  ...
  // Fetch products from the backend, applying category filter if selected
  ...
  // Reload products whenever the category filter changes
  useEffect(() => {
    fetchProducts();
